...
which_python_UI <- function(id){
  ...
  # build output
  withSpinner(verbatimTextOutput(ns('which_python')), proxy.height = "100px")
...
python_version_UI <- function(id){
  ...
  # build output
  withSpinner(verbatimTextOutput(ns('python_version')), proxy.height = "100px")
...
sysinfo_UI <- function(id){
  ...
  # build output
  withSpinner(DT::dataTableOutput(ns("sysinfo")), proxy.height = "200px")
